                                ...
                                <div class="row">
                                        <div class="col-md-4">
                                                <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="data[User][zipcode]" id="zipcode">
                                                </div>
                                        </div>
                                        <div class="col-md-5">
                                                <div class="form-group">
                                                        ...
                                                        <input class="form-control tooltips" type="text" data-original-title="We'll display it when you write reviews" data-rel="tooltip"  title="" data-placement="top" name="data[User][city]" id="city">
                                                </div>
                                        </div>
