		...
		if (strlen($data['name'])>4){ 
                    ...
                    {                    
						...
						if($filetype=='png'){
							 ...
							 */
						if($folderName!='temp_model_images' && $folderName!='temp_agency_images' && $folderName!='temp_pc_images' && $folderName!='temp_pm_images'){
							$this->resizeImage('resizeCrop', $tempuploaddir, $filename, $homeuploaddir, $filename, 886, 711, 85);
							/*
							 *	Generate the big version of the image with max of $imgscale in either directions
							 */
							$this->resizeImage('resizeCrop', $tempuploaddir, $filename, $biguploaddir, $filename, $maxw, $maxh, 75);							
						...
						if($folderName=='temp_model_images' || $folderName=='temp_agency_images' || $folderName=='temp_pc_images'  || $folderName=='temp_pm_images' ){
								$this->resizeImage('resize', $tempuploaddir, $filename, $homeuploaddir, $filename, $maxw, $maxh, 85);	
							}
